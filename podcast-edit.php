	...
	<div class="row">
		...
		<div class="span9">
			...
			<ul class="breadcrumb">
				...
				<li><a href="podcasts.php">Tous les podcasts</a> <span class="divider">/</span></li>
				<li><a href="podcast.php?id=<?php echo $row[0]; ?>"><?php echo $row[1]; ?></a> <span
			...
			<form class="form-horizontal">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" id="titre" name="titre"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" id="url_rss"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" id="url_site"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" id="url_freepod"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-xlarge" id="logo"
								name="logo" value="<?php echo $row[9]; ?>">
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<input type="submit" class="btn-primary btn-large" value="Enregistrer">
						</div>
					</div>
				</fieldset>
